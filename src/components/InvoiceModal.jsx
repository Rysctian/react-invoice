  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog
        ...
        onClose={closeModal}
      >
        <div className="min-h-screen font-inter px-4 text-center">
          <Transition.Child
            as={Fragment}
          ...
          >
            <div className="my-8 inline-block px-2 py-5 w-full max-w-md transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all">
              <div className="p-4" id="print">
                ...
                <div className="mt-6">
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-y border-black/10 text-sm md:text-base">
                        ...
                        <th className="text-right border-l">AMOUNT</th>
                      </tr>
                    </thead>
                    <tbody>
                      {items.map((item) => (
                  ...
                  <div className="mt-4 text-gray-600 font-medium text-gray-800 flex flex-col items-end space-y-2">
                    ...
                    <div className="flex w-full text-black justify-between border-t bg-gray-300 rounded-md px-2 border-black/10 py-2">
